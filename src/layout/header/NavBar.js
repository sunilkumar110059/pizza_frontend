...
function NavBar() {
  ...
  const logOutHandle = () => {
    dispatch(userAthenticateFn(localStorage.removeItem("AUTH")))
  }
        ...
        <div className="cover py-2 bordercolor2_4 border_bottom1">
          <div className='container'>
            <div className="row navbar">
              ...
              {userToken && <div className="col-auto d-flex align-items-center fw-bold">
                <NavLink to={ROUTE_CLIENT.PRODUCTS_PATH}>Product</NavLink>
              </div>}

              <div className="col-auto d-flex align-items-center fw-bold"><NavLink to={ROUTE_CLIENT.CONTACT_PATH}>Contact Us</NavLink></div>

              {!userToken &&
                <div className="col-auto d-flex align-items-center fw-bold">
                  <NavLink to={ROUTE_CLIENT.LOGIN_PATH}>Login</NavLink>
                </div>
              }
              ...
              {userToken &&
                <div className="col-auto d-flex align-items-center fw-bold">
                  <NavLink to={ROUTE_ADMIN.ADD_PRODUCT_PATH}> Add Product</NavLink>
                </div>
              }
